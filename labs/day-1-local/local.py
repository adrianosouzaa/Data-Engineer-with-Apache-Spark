...
if __name__ == '__main__':
    ...
    df_movies = spark.read \
        ...
        .json("C:/Users/ACT/Documents/de-apache-spark/files/landing-zone/movies/*.json")
    ...
    df_rating = spark.read \
        ...
        .option("encoding", "UTF-8") \
        .option("charset", "UTF-8") \
        .json("C:/Users/ACT/Documents/de-apache-spark/files/landing-zone/user/*.json")
    ...
    df_join.write.mode("overwrite").format("parquet").save("C:/Users/ACT/Documents/de-apache-spark/files/processing/delta-join/")
